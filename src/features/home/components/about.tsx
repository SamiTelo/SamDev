...
export const AboutSection = () => {
  ...
  return (
    <section
      id="about"
      className="relative overflow-hidden pt-18 pb-42 px-6 sm:px-10 lg:px-12 -mt-30 md:-mt-30 sm:mt-8"
    >
      {/* IMAGE BG TOP RIGHT */}
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 md:gap-8 gap-30 items-center">
        ...
        <motion.div
          ...
          className="relative flex justify-center lg:justify-start -ml-6 sm:ml-0 md:ml-0 pl-0 md:pl-10 order-2 md:order-1"
        >
          <div className="relative w-full max-w-md">
            ...
            {/* Badge 1 */}
            <div className="absolute bottom-10 md:bottom-26 left-0 md:-left-10 bg-primary-foreground py-4 px-6 md:px-10 rounded-xl shadow-2xl flex items-center space-x-4 border border-gray-100">
            ...
            <motion.div
              ...
              className="absolute top-30 md:top-30 -right-4 md:-right-24 bg-primary-foreground py-4 md:py-6 px-4 md:px-10 rounded-xl shadow-2xl flex items-center space-x-4 border border-gray-100"
            >
        ...
        <div className="space-y-6 md:-mt-6 -mt-1 order-1 md:order-2">
          ...
          >
            <p className="sm:text-[16px] md:text-[16px] text-sm text-gray-700 leading-relaxed max-w-xl">
              Passionné par la création d’applications modernes, performantes et
              intuitives, j’ai acquis les compétences nécessaires pour
              transformer vos idées en solutions concrètes. J’interviens à
              chaque étape : de l’analyse du besoin à la conception, au
              développement, aux tests, à l’optimisation et à la mise en ligne.{" "}
              <br />
              <br />
              Mon objectif est de livrer des solutions fiables, maintenables et
              pensées pour durer, en alliant performance technique et design
              soigné, tout en offrant une expérience utilisateur fluide et
              impactante.
            </p>
