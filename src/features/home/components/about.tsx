...
export const AboutSection = () => {
  return (
    <section className="py-16 px-6 lg:px-12 bg-cover bg-center bg-[url('/assets/About-bg.png')] md:h-242 h-auto -mt-30 md:-mt-30 sm:mt-8" >

      {/*----------------------------------------------
           Main Content Grid 
        ----------------------------------------------------*/}
      <div className="max-w-7xl mx-auto  grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 md:gap-8 gap-30 items-center">
        
        {/* ---------------------------------------- 
        BLOC GAUCHE : IMAGE ET BADGES 
        ----------------------------------------------- */}
        <div className="relative flex justify-center lg:justify-start md:pl-10 order-2 md:order-1">
          <div className="relative w-full max-w-md">
            ...
            <div className="absolute bottom-10 sm:bottom-26 md:bottom-26 -left-4 md:-left-10 bg-white py-4 px-6 md:px-10 rounded-xl shadow-2xl flex items-center space-x-4 border border-gray-100">
              ...
              <p className="text-gray-700 font-medium md:text-[16px] text-xs leading-tight">
                Années <br /> d&apos;Exp
              </p>
            </div>

            {/* Badge : Projets (Haut-Droite) */}
            <div className="absolute top-36 sm:top-30 md:top-30 -right-4 md:-right-24 bg-white py-4 md:py-6 px-4 sm:px-6 md:px-10 rounded-xl shadow-2xl flex items-center space-x-4 border border-gray-100">
