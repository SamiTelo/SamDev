...
export const HeroSection = () => {
  return (
    <section
      id="hero"
      className="relative min-h-200 w-full px-6 sm:px-10 py-12 -top-44 lg:px-20 md:pb-38 md:pt-32 pt-52  bg-cover bg-center bg-[url('/assets/hero-bg.svg')]"
    >
      {/*----------------------------------------------
           Main Content Grid 
        ----------------------------------------------------*/}
      ...
      ----------------------------------------------- */}
        <motion.div
          ...
          className="flex-1 py-8 md:mt-12 -mt-4 md:pl-2.5 pl-0"
        >
          {/* Badge */}
          <motion.div
            animate={{ y: [0, -5, 0] }}
          ...
          <p className="mt-6 sm:text-[16px] md:text-[16px] text-sm text-gray-700 text-center md:text-left leading-relaxed">
            ...
            performantes et adaptées aux besoins réels. J’allie front-end
            (NextJS, Flutter), back-end (NestJS) API robuste et sécuriser pour
            transformer vos idées en solutions concrètes, intuitives et
            efficaces de A à Z.
          </p>
          ...
          <div className="mt-8 flex flex-col items-center gap-6 md:flex-row md:justify-start md:gap-8">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="rounded-full bg-[#F6F9FC] p-3 hover:text-[#FF5722] transition-colors"
              >
