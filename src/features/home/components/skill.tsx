...
const skills = [
  ...
  { name: 'CSS', icon: '/assets/skills/css-icon.png' },
  ...
  { name: 'Intelligence Artificielle', icon: <Cpu className="w-10 h-10 text-gray-700" /> },
];

export const SkillSection = () => {
  return (
    <section className="py-0 sm:py-30 md:py-30 bg-white">
      <div className="container mx-auto px-6 sm:px-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-slate-500 sm:text-[16px] md:text-[16px] text-sm leading-relaxed">
            Un ensemble de compétences techniques et créatives me permettant de concevoir des solutions web et mobiles modernes, responsives et performantes.
          </p>
        </div>

        {/* Main Content Grid */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 mt-30 sm:mt-38 md:mt-38">
          {skills.map((skill, index) => (
            <div 
              key={index} 
              className="flex flex-col items-center justify-center p-6 bg-slate-50  hover:shadow-md transition-shadow duration-300 border border-slate-100"
            >
