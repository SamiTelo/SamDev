  ...
  return (
    <section className="relative min-h-screen bg-[#f7f7f8] overflow-hidden flex flex-col">
      ...
      <motion.main
        ...
        className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 py-16 gap-8"
      >
        ...
        <div className="relative flex items-center justify-center">
          ...
          {/* Sparkle top-left */}
          <svg
            className="absolute -top-3 left-4 text-green-400 w-5 h-5"
            viewBox="0 0 24 24"
            fill="currentColor"
          >
          ...
          {/* Sparkle right */}
          <svg
            className="absolute top-2 -right-2 text-green-300 w-4 h-4"
            viewBox="0 0 24 24"
            fill="currentColor"
          >
            <path d="M12 2l1.5 4.5L18 8l-4.5 1.5L12 14l-1.5-4.5L6 8l4.5-1.5z" />
        ...
        <Link
          href="/"
          className="flex items-center gap-3 bg-primary hover:bg-black active:scale-95 transition-all text-white font-semibold text-base px-10 py-4 rounded-full shadow-lg shadow-orange-200 hover:shadow-black/50"
        >
      ...
      <footer className="relative z-10 border-t border-gray-100 bg-white/60 backdrop-blur-sm py-5">
        <div className="flex items-center justify-center gap-4">
          ...
          <div className="hidden w-10 h-10 rounded-full bg-orange-50 border border-orange-100 md:flex items-center justify-center">
            <Mail size={18} className="text-primary" strokeWidth={1.8} />
          </div>
          <div className="text-center">
            <p className="text-sm text-gray-500">
              Une question urgente ? N&apos;hésitez pas à me contacter
              directement
            </p>
            <a
